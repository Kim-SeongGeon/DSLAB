...
Window C 드라이브 파일이 아닌 Mission Planner 설치 때 연동되는 github 내에 있어서 바꿔보고 Mission Planner map에도 잘 나오는지 확인해야 함. => 바뀌는 거 확인 후 Mission Planner <-> Google Earth 연동해야할 듯듯
